...
import { array, boolean, date, object, safeParse, string, type Output, type Issues } from "valibot";
...
> {
  ...
  return parsed.success ? Ok({ frontmatter: parsed.output, content }) : Err(parsed.issues);
}
